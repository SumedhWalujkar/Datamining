...
def pickData(filename,class_numbers,training_instances,test_instances,choice):
    ...
    #inpu=int(input("Do you want prediction or k fold validation? \nEnter 0 for prediction and 1 for cross validation\n"))
        ...
        for i in range (0,len(train_data)):
            TrainX.append(train_data[i][1:321])
            TrainY.append(train_data[i][0])
        for i in range (0,len(test_data)):
            TestX.append(test_data[i][1:321])
...
def validator(final):
    ...
    plt.show()
#########################################################################################################
def dodande(filename,letters,noctc):
...
noctbc=int(input("Enter the number of elements you want to consider:\n"))
number_of_classes=int(input("Input the number of classes of each data item:\n"))
letters=[]
...
if(cghi==0):
    ...
    ender=dodande(filename,letters,number_of_classes)
